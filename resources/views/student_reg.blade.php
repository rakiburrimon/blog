        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{action('StudentController@create')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('result') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="result" type="text" class="form-control" name="result" value="{{ old('result') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('batch') ? ' has-error' : '' }}">
                            <label for="batch" class="col-md-4 control-label">Batch Name</label>
                        ...
                        <div class="form-group{{ $errors->has('course') ? ' has-error' : '' }}">
                            <label for="course" class="col-md-4 control-label">Course Name</label>
